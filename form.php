...
<html>
	...
	<body>
		...
		<form id="cadastro" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
			Nome: <input type="text" name="name" value="<?php echo $name;?>" required>
			<span class="error">* <?php echo $nameErr;?></span>
			<br><br>
			
			Idade: <input type="text" name="age" value="<?php echo $age;?>"required>
			<span class="error">* <?php echo $nameErr;?></span>
			<br><br>
			
			Endereco: <input type="text" name="address" value="<?php echo $address;?>"required>
			<span class="error">* <?php echo $addressErr;?></span>
			<br><br>
	
			Telefone: <input type="text" name="phone" value="<?php echo $phone;?>"v>
			...
			Sexo: 
				  <br><input type="radio" name="gen"  value="M"  >	Masculino <br>
				  <input type="radio" name="gen"  value="F"  >	Feminino<!---->
				  <br><br>
			<input type="button" onclick="validaForm();" name="btnSubmit" value="Cadastrar">  
		</form>
